%% ========================================================================
% optimize_kl_params_for_smoldyn.m
%
% DESCRIPTION:
%   Loads pre-averaged Smoldyn data and sweeps through a range of delay
%   parameters for the 'uniform' and 'multi-random' post-processing
%   methods to find the optimal values for minimizing NRMSE.
%
% =========================================================================
...
fprintf('Loading pre-averaged Smoldyn data...\n');
[file, path] = uigetfile('*.mat', 'Select the averaged_smoldyn_data.mat file');
...
for i = 1:length(uniform_delay_sweep)
    ...
    % Train and test with this delay
...
figure('Name', 'KL Parameter Optimization for Smoldyn Data', 'Position', [100, 100, 1200, 500]);
