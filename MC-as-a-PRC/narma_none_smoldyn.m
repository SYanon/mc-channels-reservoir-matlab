% =========================================================================
% NARMA10_Generate_Smoldyn_Baseline.m
%
% DESCRIPTION:
%   Generates Smoldyn data for the NARMA10 task using the best
%   hyperparameters found via Bayesian Optimization for the BASELINE ('none')
%   configuration.
% =========================================================================
...
%% 1. Parameter Setup
% Updated with the Bayesian Optimized values for the 'none' method.

% Receptor and binding parameters
N = 500;
k_on = 1.9961e-17;     % -- BAYESIAN OPTIMIZED (BASELINE)
k_off = 9.998;         % -- BAYESIAN OPTIMIZED (BASELINE)
KD = k_off / k_on;

% Time parameters
T = 1.9959;            % Symbol duration (s) -- BAYESIAN OPTIMIZED (BASELINE)
...
distance = 1.0006e-06;   % Distance (m) -- BAYESIAN OPTIMIZED (BASELINE)
D = 1.9997e-10;        % Diffusion coefficient (m^2/s) -- BAYESIAN OPTIMIZED (BASELINE)

% Input normalization parameters
N_min = 100;
N_max = 19985;         % -- BAYESIAN OPTIMIZED (BASELINE)
...
% ===========================================================
fprintf('Setting up Smoldyn simulation for BASELINE optimized parameters...\n');
tic;
...
dirname = sprintf('NARMA_Optimized_Baseline_%s/', datestr(now,'mm-dd-yyyy--HH-MM-SS'));
mkdir(dirname);
