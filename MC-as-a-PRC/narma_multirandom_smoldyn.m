% =========================================================================
% NARMA10_Generate_Smoldyn_MultiRandom.m
%
% DESCRIPTION:
...
N = 500;
k_on = 5.1573e-20;     % -- BAYESIAN OPTIMIZED (MULTI-RANDOM)
k_off = 6.0292;        % -- BAYESIAN OPTIMIZED (MULTI-RANDOM)
KD = k_off / k_on;

% Time parameters
T = 1.8579;            % Symbol duration (s) -- BAYESIAN OPTIMIZED (MULTI-RANDOM)
...
distance = 4.8991e-05;   % Distance (m) -- BAYESIAN OPTIMIZED (MULTI-RANDOM)
D = 1.9071e-10;        % Diffusion coefficient (m^2/s) -- BAYESIAN OPTIMIZED (MULTI-RANDOM)

% Input normalization parameters
N_min = 100;
N_max = 6278.2;        % -- BAYESIAN OPTIMIZED (MULTI-RANDOM)
...
dirname = sprintf('NARMA_Optimized_MultiRandom_%s/', datestr(now,'mm-dd-yyyy--HH-MM-SS'));
mkdir(dirname);
