%% ========================================================================
%  ANALYSIS SCRIPT: MG CUBED - WITH STOCHASTIC FILTERING
% ========================================================================
%
% This script compares four signals for the Mackey-Glass Cubed task:
%   1. Ground Truth
%   2. Deterministic Prediction
%   3. Averaged Stochastic Prediction (Raw)
%   4. Filtered Stochastic Prediction (Smoothed)
%
% It uses the optimal hyperparameters from Iteration 91.
%
% =========================================================================

%% 0. Initialize Environment & Auto-Detect Data Folders
clear; close all; clc;
fprintf('Starting analysis of MG CUBED with filtering...\n');
...
%% 1. Parameter Setup (from Iteration 91)
fprintf('Using hyperparameters from optimized Iteration 91.\n');
...
N_min = 100; N_max = 11345; predictlength = 10;
...
target_series = target_series(1:num_tot_points);
...
figure('Name', 'MG Cubed: Model Comparison', 'Position', [100, 100, 1200, 600]);
...
hold off;
title('Model Comparison on Mackey-Glass Cubed Test Set (Iter 91)');
